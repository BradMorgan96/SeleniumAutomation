 ...
 *
 * The aim of this test is to verify that invalid Exeter Quotes cannot be added..
 */

public class DEV1865_ExeterQuotingInvalidPremium extends TestBase.ClassGlobals {
    ...
    public void main() {
        try {
            ...
            String[] invalidPremiums = ExeterFieldArray.invalidPremiums;
            ...
            for (int leadProviderPosition = 0; leadProviderPosition < leadProviders.length; leadProviderPosition++) {
                for (int leadStatusPosition = 0; leadStatusPosition < leadStatuses.length; leadStatusPosition++) {
                    ...
                    for (int affectedLivesPosition = 0; affectedLivesPosition < affectedLives.length; affectedLivesPosition++) {
                        ...
                        for (int invalidPremiumPosition = 0;  invalidPremiumPosition < invalidPremiums.length; invalidPremiumPosition++) {
                            ...
                            String validPremiumsString = invalidPremiums[invalidPremiumPosition];
                            ...
                            try {
                                ...
                                String QuotedPremiumConverted = QuotedPremium.substring(QuotedPremium.indexOf("£") + 1, QuotedPremium.indexOf("pm"));
                                com.log(logFile, "INFO: Quoted Premium found is " + QuotedPremiumConverted);

                                if (QuotedPremiumConverted.contains(invalidPremiums[invalidPremiumPosition])) {
                            ...
                            //Verify the correct lead provider is displayed
                                ...
                                com.log(logFile, "FAIL: QUOTE NOT FOUND!");
                            }
