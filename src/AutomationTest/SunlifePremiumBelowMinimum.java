...
public class SunlifePremiumBelowMinimum extends ClassGlobals {
    ...
    public void main() throws FileNotFoundException {
        ...
        /* TEST CASE 1: SUNLIFE SINGULAR EXISTING NON SMOKER POLICY WITH PREMIUM AT 3.00 */
        System.out.println("----TEST CASE 1: SUNLIFE SINGULAR EXISTING NON SMOKER POLICY WITH PREMIUM AT 3.00----");
        ...
        /* TEST CASE 2: SUNLIFE SINGULAR EXISTING NON SMOKER POLICY WITH PREMIUM AT 2.00 */
        System.out.println("----TEST CASE 2: SUNLIFE SINGULAR EXISTING NON SMOKER POLICY WITH PREMIUM AT 2.00----");
        maxPremium.clear();
        maxPremium.sendKeys("2");
        generateGOF.click();
        ...
        /* TEST CASE 3: SUNLIFE SINGULAR EXISTING NON SMOKER POLICY WITH PREMIUM AT 1.00 */
        System.out.println("----TEST CASE 3: SUNLIFE SINGULAR EXISTING NON SMOKER POLICY WITH PREMIUM AT 1.00----");
        maxPremium.clear();
        maxPremium.sendKeys("1");
        generateGOF.click();
        ...
        /* TEST CASE 4: SUNLIFE SINGULAR EXISTING SMOKER POLICY WITH PREMIUM AT 3.00 */
        System.out.println("----TEST CASE 4: SUNLIFE SINGULAR EXISTING SMOKER POLICY WITH PREMIUM AT 3.00----");
        ...
        /* TEST CASE 5: SUNLIFE SINGULAR EXISTING SMOKER POLICY WITH PREMIUM AT 2.00 */
        System.out.println("----TEST CASE 5: SUNLIFE SINGULAR EXISTING SMOKER POLICY WITH PREMIUM AT 2.00----");
        maxPremium.clear();
        maxPremium.sendKeys("2");
        generateGOF.click();
        ...
        /* TEST CASE 6: SUNLIFE SINGULAR EXISTING SMOKER POLICY WITH PREMIUM AT 1.00 */
        System.out.println("----TEST CASE 6: SUNLIFE SINGULAR EXISTING SMOKER POLICY WITH PREMIUM AT 1.00----");
        maxPremium.clear();
        maxPremium.sendKeys("1");
        generateGOF.click();
        ...
        /* TEST CASE 7: SUNLIFE SINGULAR NEW NON SMOKER POLICY WITH PREMIUM AT 3.00 */
        System.out.println("----TEST CASE 7: SUNLIFE SINGULAR NEW NON SMOKER POLICY WITH PREMIUM AT 3.00----");
        drpSmoker.selectByIndex(1);
        maxPremium.clear();
        maxPremium.sendKeys("3");
        ...
        /* TEST CASE 8: SUNLIFE SINGULAR NEW NON SMOKER POLICY WITH PREMIUM AT 2.00 */
        System.out.println("----TEST CASE 8: SUNLIFE SINGULAR NEW NON SMOKER POLICY WITH PREMIUM AT 2.00----");
        maxPremium.clear();
        maxPremium.sendKeys("2");
        generateGOF.click();
        ...
        /* TEST CASE 9: SUNLIFE SINGULAR NEW NON SMOKER POLICY WITH PREMIUM AT 1.00 */
        System.out.println("----TEST CASE 9: SUNLIFE SINGULAR NEW NON SMOKER POLICY WITH PREMIUM AT 1.00----");
        maxPremium.clear();
        maxPremium.sendKeys("1");
        generateGOF.click();
        ...
        /* TEST CASE 10: SUNLIFE SINGULAR NEW SMOKER POLICY WITH PREMIUM AT 3.00 */
        System.out.println("----TEST CASE 10: SUNLIFE SINGULAR NEW SMOKER POLICY WITH PREMIUM AT 3.00----");
        drpSmoker.selectByIndex(2);
        maxPremium.clear();
        maxPremium.sendKeys("3");
        generateGOF.click();
        ...
        /* TEST CASE 11: SUNLIFE SINGULAR NEW SMOKER POLICY WITH PREMIUM AT 2.00 */
        System.out.println("----TEST CASE 11: SUNLIFE SINGULAR NEW SMOKER POLICY WITH PREMIUM AT 2.00----");
        maxPremium.clear();
        maxPremium.sendKeys("2");
        generateGOF.click();
        ...
        /* TEST CASE 12: SUNLIFE SINGULAR NEW SMOKER POLICY WITH PREMIUM AT 1.00 */
        System.out.println("----TEST CASE 12: SUNLIFE SINGULAR NEW SMOKER POLICY WITH PREMIUM AT 1.00----");
        maxPremium.clear();
        maxPremium.sendKeys("1");
        generateGOF.click();
