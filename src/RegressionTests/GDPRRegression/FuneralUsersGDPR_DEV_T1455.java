 ...
 */
public class FuneralUsersGDPR_DEV_T1455 extends TestBase.ClassGlobals{
    ...
    public void main() {
        ...
        try{
            //Sign in as dwilkins
            com.userLogin(logFile, "mmoorefp");
            com.log(logFile, "Sign in to CRM as mmoorefp -> Signed in to CRM");

            //Fish for a new lead
            driver.get(testEnvironment + "/Leads/view/500199");
