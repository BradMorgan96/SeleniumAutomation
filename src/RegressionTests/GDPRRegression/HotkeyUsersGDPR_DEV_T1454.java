 ...
 */
public class HotkeyUsersGDPR_DEV_T1454 extends TestBase.ClassGlobals{
    ...
    public void main() {
        ...
        try{
            //Sign in as dwilkins
            com.userLogin(logFile, "freecehk");
            com.log(logFile, "Sign in to CRM as freecehk -> Signed in to CRM");

            //Fish for a new lead
            driver.get(testEnvironment + "/Hotkeys/index/0/");
            driver.findElement(By.linkText("View")).click();
            Thread.sleep(2500);
            if( !driver.getCurrentUrl().contains("/Hotkeys/view/") ){
