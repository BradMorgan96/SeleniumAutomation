 ...
 */
public class EveryLeadProviderYesPrivacyNotice extends TestBase.ClassGlobals{
    ...
    public void main(){
         ...
         *
         * The test outputs to a logfile, used for storing the overall
         * result, and this file contains SQL for updating the lead to
         * the correct status.
         *
         * Only leads which are from one of the lead providers listed
         * in the `leadProvidersListOne` list, and are not in the status
         * of `sold` should be sent the privacy notice.
         */
        ...
        for(int i=0; i<LeadProviders.leadProvidersListOne.length; i++){
            for(int s=0; s<LeadStatuses.leadStatuses.length; s++) {
                //Get the name of the lead provider
                String leadProviderName = LeadProviders.leadProvidersListOne[i];
        ...
        com.log(logFile, "INFO: When you send the privacy notices, " + privacyNoticeLeadCount + " messages should be sent.");
